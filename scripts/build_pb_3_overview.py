...
对称 pb_2_overview / pb_6_overview。3.1.1-3.2.4 全 9 节点上线。
...
CARDS = [
    ...
    ("3.1.1", "海外矿·财报产量", "pb_311_overseas_mine.html",
     "图1 ILZSG全球铅矿产量时序 / 图2 铅矿到港(防城) / 图3 进口铅精矿港口库存",
     "j311_ilm ILZSG全球铅矿产量(月) · i16 防城港铅矿到港(月) · i5 进口铅精矿港口库存(周)",
     "102月+293月+155周 3图全真", "✅ 已上线"),
    ("3.1.2", "海外矿·分国别总量", "pb_312_overseas_by_country.html",
     "图1 全球产量 vs 中国进口占比 / 图2 全球产量季节图 / 图3 进口分港口结构",
     "j311_ilm 全球铅矿产量(3.1.1正主) · i40 海关铅精矿进口(6.1正主) · i16/i5 港口到港与库存",
     "3图全真·注：无独立分国别矿产量序列，以进口结构代理", "✅ 已上线"),
    ("3.1.3", "国内矿产量", "pb_313_domestic_mine.html",
     "图1 青海铅精矿产量时序 / 图2 青海产量季节图 / 图3 国内铅精矿原料库存",
     "j313_qh 青海铅精矿产量(月,国内矿第一大省) · i10 铅精矿原料库存(月)",
     "65月 3图全真", "✅ 已上线"),
    ("3.1.4", "矿进口量与分国别", "pb_314_mine_import.html",
     "图1 海关铅精矿进口量 / 图2 SMM净进口量 / 图3 进口 vs 到港节奏",
     "i40 海关铅精矿进口(6.1正主,本页为矿进口视角) · j314_net_imp SMM净进口(月)",
     "3图全真", "✅ 已上线"),
    ("3.1.5", "TC 加工费", "pb_315_tc_fee.html",
     "图1 国产TC时序+进口TC辅助 / 图2 国产TC季节图 / 图3 TC分位带",
     "j25_tc 国产TC(正主,题材=铅精矿加工费) · j73_imp_tc 进口TC(辅助,7.3正主)",
     "日度1370+1570点 3图全真", "✅ 已上线"),
    ("3.2.1", "精炼产量", "pb_321_refining_output.html",
     "图1 原生铅产量时序 / 图2 原生vs再生产量 / 图3 原生产量季节图",
     "j323_native_output Mysteel原生铅产量(月) · j323_regen_output 再生精铅产量(月)",
     "月度 3图全真", "✅ 已上线"),
    ("3.2.2", "开工率与检修", "pb_322_operating_rate.html",
     "图1 原生铅产能利用率(周) / 图2 原生vs再生开工率 / 图3 产能利用率季节图",
     "j322_native_util_w 原生产能利用率(周) · j322_native_util_m (月) · j323_smm_regen_rate 再生开工率",
     "338周+79月 3图全真", "✅ 已上线"),
    ...
    ("3.2.4", "冶炼利润→供应弹性", "pb_324_profit_elasticity.html",
     "图1 铅锭-再生精铅价差 / 图2 再生铅炉型利润对比 / 图3 反射炉利润季节图",
     "j324_primary_spread 铅锭-再生精铅价差(日,1478点) · j324_regen_profit_refl 反射炉 · j324_regen_profit_bof 富氧侧吹炉",
     "日度1870点 3图全真", "✅ 已上线"),
]
...
<div class="wrap">
  ...
  <div class="sub">9 个子节点 · 3.1.1-3.2.4 全部上线（3 图全真数据）· indicators_v1.json v3.1 · 2026-08-31</div>
  ...
  <div class="note">
    ...
    <b>矿端数据源已刷新：</b>早期矿端缓存陈旧（i16 防城到港止于 2020、i5 精矿港口库存止于 2023-09），故 3.2.3 先行上线；现已全部刷新至 2026-08（i16 293 点 2020-01~2026-08、i5 155 点 2023-09~2026-08），3.1.x 矿端四节点均已上线。<br>
